...
from src.utils.img_utils import pil_to_cv2, cv2_to_pil, center_crop_cv2, pils_from_video, save_videos_from_pils, \
...
def process_video(uploaded_img, uploaded_audio, width, height, length, facemask_dilation_ratio, facecrop_dilation_ratio,
...
if __name__ == '__main__':
    ...
    final_output_path = process_video(
        ...
        "assets/test_audios/jane.wav", 512, 512,
        320, 0.1,
        0.5, 12,
        3, 1.0, 6,
        16000, 24, "cuda"
